...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"If you find yourself haveing to cross a piranha-infested river,here's how to do it...");
		// Get the user to enter an adjective
		String adjective = JOptionPane.showInputDialog("Please enter an adjective");
		// Get the user to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Please enter a type a liquid");
		// Get the user to enter a body part
		String bodypart = JOptionPane.showInputDialog("Please enter any kind of body part");
